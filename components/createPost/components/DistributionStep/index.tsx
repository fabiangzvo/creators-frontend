...
function StepDistribution(props: StepComponentProps): JSX.Element {
  ...
  const [activeTab] = useState<TabType>("distributions");
        ...
        {activeTab === "distributions" ? (
          <>
            ...
            <div className="mt-8 flex items-start gap-3 px-4">
              ...
              <p className="text-xs text-default-400 leading-relaxed">
                Seleccionar un set de distribución publicará en todos los
                canales incluidos. Puedes editar publicaciones individuales en
                el siguiente paso.
              </p>
            </div>
          </>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {channels.map((channel) => (
              <div
                key={channel.id}
                className="border border-default-200 rounded-xl p-3 bg-background flex items-center gap-4"
              >
